...
class Constants {
  ...
  static final String API_VERSION = "3.4.0"
  static final String VERSION = "4.2.1"
  static final String VERSION_DATE = "January 2010"
  static final String API_VERSION_STR = "Horizon API release $API_VERSION"
  static final String COPYRIGHT =
  "Copyright 2010, Jet Propulsion Laboratory, Caltech, NASA"
  static final String CLIENT_VERSION_STR =
  "PO.DAAC Ingest Client Release $VERSION, $VERSION_DATE"

  static final String SERVER_VERSION_STR =
  "PO.DAAC Ingest Server Release $VERSION, $VERSION_DATE"
  ...
  static final String METADATA_EXTENSION = ".sip"
