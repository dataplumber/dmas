...
import gov.nasa.jpl.horizon.api.Opcode
    ...
    try {
      ...
      if (manifest.operation == Opcode.ENGINE_PING) {
        ...
        if (manifest.operation == Opcode.ENGINE_JOB) {
          ...
          response.description = "Engine ${HorizonServer.instance.serverName} is currently at its maximum load of ${listener.maxCon}."
