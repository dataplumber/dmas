...
### =============================================================== ###
#                                                                     #
#  The PO.DAAC Ingestion Service Launcher Configuration               #
#                                                                     #
#  Function:                                                          #
#  This module provides utility subroutines for configurating the     #
#  PO.DAAC Ingestion Service command line programs.                   #
#                                                                     #
#  Assumptions:                                                       #
...
sub getJVMArgsCheckGUI {
   ...
   #push @args, "-Djavax.net.ssl.trustStore=$horizon/podaac-horizon.keystore";
