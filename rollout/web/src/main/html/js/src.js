...
function validateStartTime(stopTime) {
	if (stopTime !== null) {
		dijit.byId('datasetCoverage_startTimeDATE').constraints.max = stopTime;
	} else {
		delete dijit.byId('datasetCoverage_startTimeDATE').constraints.max;
	}
}
