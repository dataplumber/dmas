...
/*
** This script loads the AQUARIUS dataset policy for the Inventory 
** schema.
*/
...
VALUES (collection_id_seq.nextval, 'AQUARIUS', 'AQUARIUS', 'PROJECT', 'This collection references all of the datasets associated with the AQUARIUS project.');
...
VALUES (project_id_seq.nextval, 'AQUARIUS', 'Aquarius test project');
...
VALUES (source_id_seq.nextval, 'MetOp-A AQUARIUS', 'MetOp-A Advanced Scatterometer', 'SPACECRAFT', 6081.7, 98.7, ' MetOp-A is the first in a series of three polar-orbiting European meteorological satellites, launched on 19 October 2006 as part of the EUMETSAT Polar System. AQUARIUS data are provided through EUMETSATs EUMETCast system where they are processed at the Ocean and Sea Ice Satellite Application Facility (OSI SAF) and distributed through KNMI.');

INSERT INTO sensor (sensor_id, short_name, long_name, swath_width, description)
VALUES (sensor_id_seq.nextval, 'MetOp-A AQUARIUS', 'MetOp-A Advanced Scatterometer', 1800, 'AQUARIUS, representing 1 out of 13 instruments on board MetOp-A, is a dual fan beam C-band (5.25 GHz) vertically polarized Scatterometer, providing measurements across two 550 km swaths, separated by a 700 km nadir blind region. This dual swath configuration allows AQUARIUS to provide more than twice the daily coverage of the ERS 1 and 2 predecessors with a coverage of nearly 70% of the ice-free oceans each day.');
...
VALUES (dataset_id_seq.nextval, provider_id_seq.currval, 'AQUARIUS-1', 'MetOp-A AQUARIUS Level 2 12.5km Ocean Surface Wind Vector Product', 'EUMETSAT/OSI SAF/KNMI', 'MetOp-A AQUARIUS Level 2 12.5km Ocean Surface Wind Vectors in Full Orbit Swath', 2, 'GLOBAL OCEAN', NULL, 'N/A', 'N/A', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'AQUARIUS Wind Product User Manual, http://www.knmi.nl/scatterometer/publications/pdf/AQUARIUS_Product_Manual.pdf, http://www.osi-saf.org/, http://www.kmni.nl/scatterometer/', 'KNMIs operational Near-Real-Time AQUARIUS Level 2 ocen surface wind vector product provided in full orbit files.');
...
VALUES (dataset_id_seq.currval, 1, inventory.timestampToLong(SYSDATE), inventory.timestampToLong(SYSDATE), 'Dataset Policy created for AQUARIUS Ingestion');
...
VALUES (dataset_id_seq.currval, 'ARCHIVE-PREVIEW', 'file:///data/dev/users/podaacdev/data/archive/store/aquarius/preview/L2/data/125');
...
INSERT INTO collection (collection_id, short_name, long_name, type, description)
VALUES (collection_id_seq.nextval, 'AQUARIUS-L2-12.5km', 'MetOp-A AQUARIUS Level 2 12.5km Ocean Surface Wind Vectors in Full Orbit Swath', 'PRODUCT', 'TBD');
...
INSERT INTO dataset (dataset_id, provider_id, short_name, long_name, original_provider, provider_dataset_name, processing_level, region, region_detail, latitude_resolution, longitude_resolution, horizontal_resolution_range, altitude_resolution, depth_resolution, temporal_resolution, temporal_resolution_range, ellipsoid_type, projection_type, projection_detail, reference, description)
VALUES (dataset_id_seq.nextval, provider_id_seq.currval, 'AQUARIUS-2', 'MetOp-A AQUARIUS Level 2 25.0 km Ocean Surface Wind Vector Product', 'EUMETSAT/OSI SAF/KNMI', 'MetOp-A AQUARIUS Level 2 25.0km Ocean Surface Wind Vectors in Full Orbit Swath', 2, 'GLOBAL OCEAN', NULL, 'N/A', 'N/A', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'AQUARIUS Wind Product User Manual, http://www.knmi.nl/scatterometer/publications/pdf/AQUARIUS_Product_Manual.pdf, , http://www.osi-saf.org/, http://www.kmni.nl/scatterometer/', 'KNMIs operational Near-Real-Time AQUARIUS Level 2 ocen surface wind vector product provided in full orbit files.');
...
INSERT INTO dataset_location_policy (dataset_id, type, base_path)
VALUES (dataset_id_seq.currval, 'ARCHIVE-PREVIEW', 'file:///data/dev/users/podaacdev/data/archive/store/aquarius/preview/L2/data/250');
...
INSERT INTO collection (collection_id, short_name, long_name, type, description)
VALUES (collection_id_seq.nextval, 'AQUARIUS-L2-25km', 'MetOp-A AQUARIUS Level 2 25km Ocean Surface Wind Vectors in Full Orbit Swath', 'PRODUCT', 'TBD');
