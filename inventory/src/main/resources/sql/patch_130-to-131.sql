...
/*change GRANULE_ARCHIVE.PATH to mimic new dir structure
** First we'll do "public" -> "open"
** i.e. file:///store/quikscat/public/L3/data -> file:///store/quikscat/open/L3/data
*/
UPDATE GRANULE_ARCHIVE
SET PATH=REPLACE(path,'public','open')
WHERE PATH LIKE '%ghrsst/public%';
