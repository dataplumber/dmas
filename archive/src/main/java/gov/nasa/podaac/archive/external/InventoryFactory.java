...
public abstract class InventoryFactory
{
    ...
    public static synchronized InventoryFactory getInstance()
    {
        if (InventoryFactory.self == null)
        {
            ...
            //String defaultImplName = System.getProperty (propertyName, "gov.nasa.podaac.archive.external.wsm.Factory");
            String defaultImplName = ArchiveProperty.getInstance().getProperty(propertyName, "gov.nasa.podaac.archive.external.wsm.Factory");
