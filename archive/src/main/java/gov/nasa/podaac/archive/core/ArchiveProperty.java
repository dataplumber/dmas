...
public class ArchiveProperty {
	...
	private synchronized static void init() {
		...
		if (System.getProperty(AIP_POST) == null)
			System.setProperty(AIP_POST, "topic/podaac/aip/post");
		if (System.getProperty(AIP_STATUS) == null)
			System.setProperty(AIP_STATUS, "topic/podaac/aip/complete");
		if (System.getProperty(AIP_ACK) == null)
			System.setProperty(AIP_ACK, "topic/podaac/aip/ack");
