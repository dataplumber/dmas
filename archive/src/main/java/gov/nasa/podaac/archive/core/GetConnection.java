...
final class GetConnection
{
   ...
   private GetConnection()
   {
      ...
      try
      {
         String to = System.getProperty ("gov.nasa.podaac.archive.core.http.timeout", "60");
   ...
   public URLConnection open (URL url) throws ArchiveException
   {
      synchronized (this.lock)
      {
         ...
         if (this.thrown != null) throw new ArchiveException(GranuleArchiveStatus.MISSING,
                                                             GranuleArchiveStatus.MISSING.toString() + ": " + "URL " + url.toString() + "\n" + this.thrown.getMessage());
         if (this.connection == null) throw new ArchiveException(GranuleArchiveStatus.MISSING,
                                                                 GranuleArchiveStatus.MISSING.toString() + ": " + "URL " + url.toString() + " timed out.");
      }
