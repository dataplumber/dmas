...
import gov.nasa.podaac.common.api.jaxb.serviceprofile.SwathType;
import gov.nasa.podaac.common.api.serviceprofile.Swath;

import java.math.BigInteger;
import java.util.Date;

public class SwathJaxb extends AccessorBase implements Swath {

   private SwathType _jaxbObj;

   public SwathJaxb() {
      this._jaxbObj = new SwathType();
   }
   ...
   public SwathJaxb(Swath swath) {
      if (swath.getImplObj() instanceof SwathType) {
         this._jaxbObj = (SwathType) swath.getImplObj();
      } else {
         this._jaxbObj = new SwathType();
   ...
   public SwathJaxb(SwathType jaxbObj) {
