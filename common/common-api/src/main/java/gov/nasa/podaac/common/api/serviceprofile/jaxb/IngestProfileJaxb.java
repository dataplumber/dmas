...
public class IngestProfileJaxb extends AccessorBase implements IngestProfile {

   private SubmissionType _jaxbObj;

   public IngestProfileJaxb() {
      this._jaxbObj = new SubmissionType();
   }

   public IngestProfileJaxb(IngestProfile submission) {
      this._jaxbObj = new SubmissionType();
      this.setCompleteContent(submission.getCompleteContent());
      this.setHeader(submission.getHeader());
   }

   public IngestProfileJaxb(SubmissionType jaxb) {
      this._jaxbObj = jaxb;
   }
   ...
   public void clearCompleteContent() {
      this._getContent().setComplete(null);
   }
   ...
   public boolean equals(Object obj) {
      ...
      if (getClass() != obj.getClass())
         return false;
      final IngestProfileJaxb other = (IngestProfileJaxb) obj;
      if (_jaxbObj == null) {
