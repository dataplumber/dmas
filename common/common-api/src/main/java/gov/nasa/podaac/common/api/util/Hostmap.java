...
import gov.nasa.podaac.common.api.jaxb.hostmap.Hostmap.Host;
...
public class Hostmap extends
   Binder<gov.nasa.podaac.common.api.jaxb.hostmap.Hostmap> {
   ...
   private static final String JAXB_CONTEXT =
      "gov.nasa.podaac.common.api.jaxb.hostmap";
