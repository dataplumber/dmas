...
package gov.nasa.podaac.common.api.file;
...
/**
 * Interface to the actual file product. This interface is designed to wrap the internal representation of a file. A
 * file could be local or remote and have different ways to access it.
 *
