...
import gov.nasa.podaac.common.api.jaxb.serviceprofile.BoundingRectangleType;
...
public class BoundingRectangleJaxb extends AccessorBase implements
   ...
   private BoundingRectangleType _jaxbObj;

   public BoundingRectangleJaxb() {
      this._jaxbObj = new BoundingRectangleType();
   }

   public BoundingRectangleJaxb(BoundingRectangle boundingRectangle) {
      if (boundingRectangle.getImplObj() instanceof BoundingRectangleType) {
         this._jaxbObj = (BoundingRectangleType) boundingRectangle.getImplObj();
      } else {
         this._jaxbObj = new BoundingRectangleType();
   ...
   public BoundingRectangleJaxb(BoundingRectangleType jaxbObj) {
