...
public class VFSFileProduct implements FileProduct {
   ...
   public static FileObject getLocalFileObject(String file) {
	   try{
		   FileSystemManager vfsManager = VFS.getManager(); 
		   FileSystemOptions fileSystemOptions = new FileSystemOptions();
		   // Create FileObject 
       		FileObject fileObj = vfsManager.resolveFile(file, fileSystemOptions);
       		return fileObj;
	   }catch(FileSystemException vfsE){
		   vfsE.printStackTrace();
	   }
	   return null;
   }
