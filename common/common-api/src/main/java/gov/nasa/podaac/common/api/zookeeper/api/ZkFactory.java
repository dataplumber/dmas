...
import gov.nasa.podaac.common.api.zookeeper.core.ZkAccessImpl;
...
//			return zk;
   ...
   public static ZkAccess getZk(String hosts, Watcher watcher)
         throws IOException {
      if (zk == null) {
         log.debug("Creating new ZooKeeper");
   ...
   public static ZkAccess getZk(String hosts, Map<String, Object> session,
