...
import gov.nasa.podaac.common.api.alg.PolyTools;
import gov.nasa.podaac.common.api.alg.IndivisibleLineSegment;

import gov.nasa.podaac.common.api.serviceprofile.Point;
import gov.nasa.podaac.common.api.serviceprofile.jaxb.PointJaxb;
...
System.out.println("testPolyTools_0:p2.getLongitude() = " + p2.getLongitude());
   ...
   public void testPolyTools_1() {
      PointJaxb p1 = new PointJaxb(1.0,2.0);
      PointJaxb p2 = new PointJaxb(1.0,2.0);
