...
package gov.nasa.podaac.common.crawler.spider.registry.provider;

import gov.nasa.podaac.common.api.jaxb.crawlercache.Crawlercache;
import gov.nasa.podaac.common.api.jaxb.crawlercache.Crawlercache.Fileinfo;
...
import gov.nasa.podaac.common.crawler.spider.provider.CacheFileProduct;
...
public class FileCrawlerRegistry extends Binder<Crawlercache> implements
   ...
   private static final String JAXB_CONTEXT =
         "gov.nasa.podaac.common.api.jaxb.crawlercache";
   private static final String CACHE_SCHEMA = "podaac_crawlercache.xsd";
