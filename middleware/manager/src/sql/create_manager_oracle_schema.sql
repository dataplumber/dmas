...
CREATE TABLE ing_message_schema(
   id       NUMBER(19, 0)      NOT NULL,
   version  NUMBER(19, 0)      NOT NULL, 
...
CREATE TABLE ing_product_type_role(
   id              NUMBER(19, 0) NOT NULL,
   version         NUMBER(19, 0) NOT NULL,
   product_type_id NUMBER(19, 0) NOT NULL,
...
CREATE TABLE ing_remote_system(
   id              NUMBER(19, 0)      NOT NULL,
   version         NUMBER(19, 0)      NOT NULL, 
   created         NUMBER                     ,
...
CREATE TABLE ing_system_user_role(
   id      NUMBER(19, 0) NOT NULL,
   version NUMBER(19, 0) NOT NULL,
   role_id NUMBER(19, 0) NOT NULL,
...
CREATE TABLE ing_system_user_session(
   id              NUMBER(19, 0)      NOT NULL,
   version         NUMBER(19, 0)      NOT NULL,
   expire_time     NUMBER                     ,
...
ALTER TABLE ing_data_file ADD 
   CONSTRAINT ing_data_file_fk1
   FOREIGN KEY(provider_id) 
   REFERENCES ing_remote_system(id);
   
ALTER TABLE ing_data_file ADD 
   CONSTRAINT ing_data_file_fk2
   FOREIGN KEY(product_id) 
   REFERENCES ing_product(id);
...
ALTER TABLE ing_product ADD 
   ...
   REFERENCES ing_product_type(id);

ALTER TABLE ing_product ADD 
   CONSTRAINT ing_product_fk2 
   FOREIGN KEY(schema_id) 
   REFERENCES ing_message_schema(id);
...
ALTER TABLE ing_product_type ADD 
   ...
   REFERENCES ing_system_user(id);

ALTER TABLE ing_product_type ADD 
   CONSTRAINT ing_product_type_fk2 
   FOREIGN KEY(federation_id) 
   REFERENCES ing_federation(id);

ALTER TABLE ing_product_type_role ADD 
   CONSTRAINT ing_product_type_role_fk1 
   FOREIGN KEY(role_id) 
   REFERENCES ing_access_role(id);
...
ALTER TABLE ing_system_user_role ADD 
...
ALTER TABLE ing_system_user_session ADD 
...
CREATE SEQUENCE hibernate_sequence
   NOCACHE;
CREATE SEQUENCE ing_federation_id_seq
   NOCACHE;
CREATE SEQUENCE ing_systemuser_id_seq
   NOCACHE;
CREATE SEQUENCE ing_systemusersession_id_seq
   NOCACHE;
CREATE SEQUENCE ing_accessrole_id_seq
   NOCACHE;
CREATE SEQUENCE ing_systemuserrole_id_seq
   NOCACHE;
CREATE SEQUENCE ing_producttype_id_seq
   NOCACHE;
CREATE SEQUENCE ing_producttyperole_id_seq
   NOCACHE;
CREATE SEQUENCE ing_product_id_seq
   NOCACHE;
CREATE SEQUENCE ing_product_version_seq
   NOCACHE;
CREATE SEQUENCE ing_data_file_id_seq
   NOCACHE;
CREATE SEQUENCE ing_storage_id_seq
   NOCACHE;
CREATE SEQUENCE ing_enginejob_id_seq
   NOCACHE;
CREATE SEQUENCE ing_remotesystem_id_seq
   NOCACHE;
CREATE SEQUENCE ing_messageschema_id_seq
   NOCACHE;
