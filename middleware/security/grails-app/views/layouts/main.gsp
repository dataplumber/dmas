...
<head>
        <title>PO.DAAC Security Service</title>
	...
	<link type="text/css" rel="stylesheet" media="all" href="/security/css/podaac.css?L" />
	<link type="text/css" rel="stylesheet" media="all" href="/security/css/jquery-ui.css" />
	<script  type="text/javascript" src="/security/js/jquery.min.js"></script>
	<script  type="text/javascript" src="/security/js/jquery-ui.min.js"></script>
	

	<style type="text/css"> 
	#page-inner { width: 990px; text-align: left; margin: 0 auto; }
	 body { margin: 5em 0 0 0; vertical-align: middle; } 
	  #podaac-banner-text
	  {
	    padding-top: 30px;
	    padding-left: 5px;
	...
	/** table **/
	  ...
	  td,th{ font-family: Arial, Helvetica; font-size: 11px; }
</style>
</head>
    <body onload="init()">
    ...
    <div id="banner">
      ...
      <div id="podaac-banner">
        <a href="http://podaac.jpl.nasa.gov">
          ...
          <h3><g:meta name="app.version"></g:meta></h3>
          </div>
      </div>
