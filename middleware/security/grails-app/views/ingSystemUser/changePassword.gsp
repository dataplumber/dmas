    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                        	...
                        	<tr class="prop">
                                <td valign="top" class="name">
                                  <label for="password"><g:message code="ingSystemUser.password.label" default="Current Password" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: ingSystemUserInstance, field: 'password', 'errors')}">
                                    <g:passwordField name="passwordCurrent" maxlength="40" value="" />
                                </td>
                            </tr>
                ...
                <div class="buttons">
                    <span class="button"><g:actionSubmit class="save" action="updatePass" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
